...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(algorithm.isHappyTicket(Integer.parseInt(ticketNumber))) { // если номер билета счастливый, то об этом выводится информация на экран
                ...
                ticketInfoOut.setText("Данный номер билета не счастливый, следующим счатливым номером является "
                        + algorithm.getHappyTicket(Integer.parseInt(ticketNumber)));
            }
        }
    };
}